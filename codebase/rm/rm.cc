...
/* Create a record manager that initializes catalog information you may need to store.
 * It also creates a paged file manager using the implementation in Project 0.
 */
RM* RM::Instance()
{
    if(!_pm)
